...
exports.loadInExistingBit = loadInExistingBit;
exports.submitForm = submitForm;
exports.showEditableForms = showEditableForms;
exports.manageLevelSprint = manageLevelSprint;

var _axios = __webpack_require__(128);

var _axios2 = _interopRequireDefault(_axios);

var _editorHelpers = __webpack_require__(135);

var _LevelSprint = __webpack_require__(373);

var _LevelSprint2 = _interopRequireDefault(_LevelSprint);
...
function loadInExistingBit() {
  var getBitsByAuthor = function () {
    ...
    return function getBitsByAuthor(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  var getSingleBit = function () {
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              lengthBtns.forEach(function (btn) {
                var button = btn;
                var btnValue = '' + parseInt(btn.dataset.value, 10) + bit.word_count;
    ...
    return function getSingleBit(_x2) {
      return _ref2.apply(this, arguments);
    };
  }();

  var loadBtn = document.querySelector('#load-in-bit');
  var bitChooser = document.querySelector('#bit-chooser');
...
function manageLevelSprint() {
  var levelSprint = new _LevelSprint2.default();
}
...
exports.sizeTextAreaOnResize = sizeTextAreaOnResize;
exports.sizeTextAreaOnKeydown = sizeTextAreaOnKeydown;
exports.expandTextArea = expandTextArea;

var _debounce = __webpack_require__(364);
...
function autosize(el) {
  var height = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : el.scrollHeight;
...
function deleteWarning() {
  ...
  deleteBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      var confirm = window.confirm('Are you sure you want to delete this Bit? This is permanent.'); // eslint-disable-line no-alert
...
function sizeTextAreaOnResize(el) {
  window.addEventListener('resize', function () {
    (0, _debounce2.default)(autosize(el, '1'), 500);
    (0, _debounce2.default)(autosize(el), 500);
  });
}

// When a user depresses a key, see if you need to resize the text area
function sizeTextAreaOnKeydown(el) {
  el.addEventListener('keydown', function (e) {
    return autosize(e.target);
  });
}
...
exports.setPrompt = undefined;

var fetchPrompts = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var promptRegex, savedPrompts, prompts;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            promptRegex = /(\[WP\])/;
            savedPrompts = checkLocalStorage();
            ...
            return _context.abrupt('return', savedPrompts);

          case 4:
            _context.next = 6;
            return fetch('https://www.reddit.com/r/writingprompts.json?limit=100').then(function (response) {
              return response.json();
            })
            // Return 27 top writing prompts
            .then(function (response) {
              return response.data.children.map(function (promptItem) {
                return promptItem.data.title;
              });
            })
            // Match only [WP] tagged writing posts (the most useful for prompts)
            .then(function (promptArray) {
              return promptArray.filter(function (promptItem) {
                return promptItem.match(promptRegex);
              });
            });
          ...
          case 6:
            ...
            return _context.abrupt('return', prompts);
...
var setPrompt = exports.setPrompt = function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            promptText = (0, _context2.t0)(_context2.t1, 1);
...
function addPromptToform(promptValue) {
  var promptSubmit = document.querySelector('#prompt-submit');
...
var _timedSprint = __webpack_require__(345);

var _timedSprint2 = _interopRequireDefault(_timedSprint);

var _lengthSprint = __webpack_require__(375);

var _lengthSprint2 = _interopRequireDefault(_lengthSprint);

var _editorHelpers = __webpack_require__(135);

var _prompt = __webpack_require__(139);

var _prompt2 = _interopRequireDefault(_prompt);

var _flash = __webpack_require__(376);

var _flash2 = _interopRequireDefault(_flash);

var _sprintHelpers = __webpack_require__(65);

var _apiHelpers = __webpack_require__(377);

var _apiHelpers2 = _interopRequireDefault(_apiHelpers);
...
(0, _apiHelpers2.default)();
(0, _editorHelpers.changeTrust)();
(0, _sprintHelpers.manageLevelSprint)();
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(66), __webpack_require__(341)(module)))
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            time = parseInt(this.dataset.value, 10) * 60;
...
var isObject = __webpack_require__(136),
    now = __webpack_require__(365),
    toNumber = __webpack_require__(367);
...
var isObject = __webpack_require__(136),
    isSymbol = __webpack_require__(368);
...
var baseGetTag = __webpack_require__(369),
...
var _Symbol = __webpack_require__(138),
    getRawTag = __webpack_require__(370),
    objectToString = __webpack_require__(371);
...
var LevelSprint = function () {
    function LevelSprint() {
        _classCallCheck(this, LevelSprint);
    ...
    _createClass(LevelSprint, [{
        key: 'handleSubmit',
        value: function handleSubmit() {
            var bitForm = document.querySelector('#bit');
            if (!bitForm) return;
            bitForm.addEventListener('submit', function (e) {
                e.preventDefault();
            });
        }
    }, {
        key: 'loadUpPrompt',
        value: function loadUpPrompt() {
            var startBtn = document.querySelector('#level-start');
            if (!startBtn) return;
            startBtn.addEventListener('click', _prompt.setPrompt);
        }
    }, {
        key: 'initialize',
...
function runSprint() {
  ...
  var wordLimit = parseInt(this.dataset.value, 10);
...
exports.default = flashClickHandler;
...
var callAPI = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var element, _element$dataset, url, callback, data;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            element = e.target.dataset.url ? e.target : e.target.closest('.api');
            _element$dataset = element.dataset, url = _element$dataset.url, callback = _element$dataset.callback;
            _context.next = 4;
          ...
          case 4:
            ...
            if (!(!callback || !_customAPICallbacks2.default[callback])) {
              _context.next = 7;
              break;
            }
          ...
          case 7:
            _customAPICallbacks2.default[callback]({ data: data, element: e.target });
...
var _customAPICallbacks = __webpack_require__(378);

var _customAPICallbacks2 = _interopRequireDefault(_customAPICallbacks);
...
var customCallbackLibrary = {
  ...
  updateTrustIcon: function updateTrustIcon(options) {
...
exports.default = customCallbackLibrary;
